...
namespace ProgrammersBlog.Data.Concrete.EntityFramework.Mappings
{
    public class CommentMap : IEntityTypeConfiguration<Comment>
    {
        ...
        {
            builder.HasKey(c => c.Id); // primary key alanımızı belirledik
            builder.Property(c => c.Id).ValueGeneratedOnAdd(); // 1 - 1 artmasını istediğimiz için verdik
            ...
            //        Bir makalenin              birden fazla       yorumu        olabilir
            // Nerede ıd kullanıyorsak orada bir ilişki yapıyoruz demektir
