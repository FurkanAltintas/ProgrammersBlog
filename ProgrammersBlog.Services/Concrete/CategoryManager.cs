...
namespace ProgrammersBlog.Services.Concrete
{
    public class CategoryManager : ICategoryService
    {
        ...
        public async Task<IDataResult<CategoryDto>> Add(CategoryAddDto categoryAddDto, string createdByName)
        {
            ...
            // Eklenmiş olan kategori bilgisini alıyoruz
        ...
        public async Task<IDataResult<CategoryDto>> Get(int categoryId)
        {
            ...
            if (category != null) // boş değil ise
            {
        ...
        public async Task<IDataResult<CategoryListDto>> GetAll()
        {
            ...
            {
                /* Neden -1 ? 
                 * Çünkü bizlere gelen listede 0 tane kategoride olabilir. Belki biz hiç kategori eklememişte olabiliriz.
                 */
        ...
        public async Task<IDataResult<CategoryDto>> Update(CategoryUpdateDto categoryUpdateDto, string modifiedByName)
        {
            ...
            await _unitOfWork.SaveAsync();
            // direkt bu işlem tamamlanırken return veriyor olacağız
