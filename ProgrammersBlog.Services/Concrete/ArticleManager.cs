...
namespace ProgrammersBlog.Services.Concrete
{
    public class ArticleManager : IArticleService
    {
        ...
        public async Task<IResult> Add(ArticleAddDto articleAddDto, string createdByName)
        {
            ...
            /* Hangi tipte bir mapping işlemi yapılacak ? Sana hangi tipi dönüyim. Biz Article istediğimiz için veriyoruz. Kaynak olarakta articleAddDto veriyoruz ve Article olarak bize geri dönüyor */
        ...
        public async Task<IResult> HardDelete(int articleId)
        {
            ...
            if (result)
            {
                ...
                return new Result(ResultStatus.Success, $"{article.Title} başlıklı makale başarıyla veritabanından başarıyla silinmiştir");
            }
        ...
        public async Task<IResult> Update(ArticleUpdateDto articleUpdateDto, string modifiedByName)
        {
            ...
            await _unitOfWork.Articles.UpdateAsync(article);
            await _unitOfWork.SaveAsync();
            return new Result(ResultStatus.Success, $"{article.Title} başlıklı makale başarıyla güncellendi.");
        }
    }
}
